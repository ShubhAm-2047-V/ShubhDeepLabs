...
List<StepData> stepsData = [
  StepData(
    ...
    options: [
      ...
      OptionItem(id: 'engineering', label: 'Engineering', icon: Icons.code, bgColor: Color(0xFFE8F5E9), borderColor: Color(0xFF66BB6A), price: 3999),
      OptionItem(id: 'mtech', label: 'M.Tech / Research', icon: Icons.memory, bgColor: Color(0xFFE1F5FE), borderColor: Color(0xFF42A5F5), price: 7499),
      OptionItem(id: 'bca-mca', label: 'BCA / MCA', icon: Icons.storage, bgColor: Color(0xFFF3E5F5), borderColor: Color(0xFFAB47BC), price: 2999),
      OptionItem(id: 'bsc-msc', label: 'B.Sc / M.Sc (IT)', icon: Icons.science, bgColor: Color(0xFFE8F5E9), borderColor: Color(0xFF66BB6A), price: 2499),
      OptionItem(id: 'ai-ml', label: 'AI / ML', icon: Icons.psychology, bgColor: Color(0xFFFFEBEE), borderColor: Color(0xFFEF5350), price: 5999),
      OptionItem(id: 'android', label: 'Android App', icon: Icons.smartphone, bgColor: Color(0xFFE8F5E9), borderColor: Color(0xFF26A69A), price: 4999),
      OptionItem(id: 'phd', label: 'PhD / Thesis', icon: Icons.school, bgColor: Color(0xFFE1F5FE), borderColor: Color(0xFF42A5F5), price: 9999),
      OptionItem(id: 'web-dev', label: 'Web Dev', icon: Icons.web, bgColor: Color(0xFFFFF9C4), borderColor: Color(0xFFFFCA28), price: 3999),
      OptionItem(id: 'ui-ux', label: 'UI/UX Design', icon: Icons.design_services, bgColor: Color(0xFFF3E5F5), borderColor: Color(0xFFAB47BC), price: 1999),
      OptionItem(id: 'cyber-sec', label: 'Cyber Security', icon: Icons.security, bgColor: Color(0xFFFFEBEE), borderColor: Color(0xFFEF5350), price: 6499),
      OptionItem(id: 'blockchain', label: 'Blockchain/Web3', icon: Icons.currency_bitcoin, bgColor: Color(0xFFE8F5E9), borderColor: Color(0xFF66BB6A), price: 6999),
    ],
  ),
  StepData(
    id: 'diploma_packages',
  ...
  StepData(
    ...
    options: [
      ...
      OptionItem(id: 'react', label: 'React.js', icon: Icons.dashboard, bgColor: Color(0xFFE1F5FE), borderColor: Color(0xFF42A5F5), price: 2499, desc: 'Interactive web dashboards', visibleForCategories: ['engineering', 'mtech', 'bca-mca', 'bsc-msc', 'phd', 'web-dev', 'blockchain']),
      OptionItem(id: 'nextjs', label: 'Next.js', icon: Icons.bolt, bgColor: Color(0xFFF3E5F5), borderColor: Color(0xFFAB47BC), price: 2999, desc: 'Full-stack SSR web apps', visibleForCategories: ['engineering', 'mtech', 'bca-mca', 'bsc-msc', 'phd', 'web-dev', 'blockchain']),
      OptionItem(id: 'mern', label: 'MERN Stack', icon: Icons.dns, bgColor: Color(0xFFFFEBEE), borderColor: Color(0xFFEF5350), price: 4499, desc: 'End-to-end JS portals', visibleForCategories: ['engineering', 'mtech', 'bca-mca', 'bsc-msc', 'phd', 'web-dev']),
      OptionItem(id: 'vue', label: 'Vue.js', icon: Icons.view_quilt, bgColor: Color(0xFFE8F5E9), borderColor: Color(0xFF66BB6A), price: 2499, desc: 'Lightweight web apps', visibleForCategories: ['engineering', 'mtech', 'bca-mca', 'bsc-msc', 'phd', 'web-dev']),
      OptionItem(id: 'angular', label: 'Angular', icon: Icons.web, bgColor: Color(0xFFFFEBEE), borderColor: Color(0xFFEF5350), price: 2999, desc: 'Enterprise frontends', visibleForCategories: ['engineering', 'mtech', 'bca-mca', 'bsc-msc', 'phd', 'web-dev']),
      OptionItem(id: 'svelte', label: 'Svelte', icon: Icons.speed, bgColor: Color(0xFFFFF9C4), borderColor: Color(0xFFFFCA28), price: 2499, desc: 'Fast web apps', visibleForCategories: ['engineering', 'mtech', 'bca-mca', 'bsc-msc', 'phd', 'web-dev']),
