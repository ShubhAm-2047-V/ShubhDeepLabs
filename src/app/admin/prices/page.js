...
const PRICE_ITEMS = [
  {
    ...
    items: [
      { id: "diploma", label: "Diploma", defaultPrice: 0 },
      { id: "engineering", label: "Engineering (B.E./B.Tech)", defaultPrice: 3999 },
      { id: "mtech", label: "M.Tech / Research", defaultPrice: 7499 },
      { id: "bca-mca", label: "BCA / MCA", defaultPrice: 2999 },
      { id: "bsc-msc", label: "B.Sc / M.Sc (IT)", defaultPrice: 2499 },
      { id: "ai-ml", label: "AI / ML", defaultPrice: 5999 },
      { id: "android", label: "Android App", defaultPrice: 4999 },
      { id: "phd", label: "PhD / Thesis", defaultPrice: 9999 },
      { id: "web-dev", label: "Web Development", defaultPrice: 3999 },
      { id: "ui-ux", label: "UI/UX Design", defaultPrice: 1999 },
      { id: "cyber-sec", label: "Cyber Security", defaultPrice: 6499 },
      { id: "blockchain", label: "Blockchain / Web3", defaultPrice: 6999 },
    ]
  },
  {
    ...
    items: [
      ...
      { id: "react", label: "React.js", defaultPrice: 2499 },
      { id: "nextjs", label: "Next.js", defaultPrice: 2999 },
      { id: "mern", label: "MERN Stack", defaultPrice: 4499 },
      { id: "vue", label: "Vue.js", defaultPrice: 2499 },
      { id: "angular", label: "Angular", defaultPrice: 2999 },
      { id: "svelte", label: "Svelte", defaultPrice: 2499 },
      { id: "python-flask", label: "Python + Flask", defaultPrice: 1999 },
      { id: "nodejs", label: "Node.js", defaultPrice: 2499 },
      { id: "django", label: "Django", defaultPrice: 2999 },
      { id: "springboot", label: "Spring Boot (Java)", defaultPrice: 4499 },
      { id: "laravel", label: "PHP / Laravel", defaultPrice: 2499 },
      { id: "sql", label: "PostgreSQL/MySQL", defaultPrice: 1499 },
      { id: "mongodb", label: "MongoDB", defaultPrice: 1499 },
      { id: "redis", label: "Redis", defaultPrice: 999 },
      { id: "firebase", label: "Firebase", defaultPrice: 1499 },
      { id: "android-dev", label: "Android (Java/XML)", defaultPrice: 5499 },
      { id: "kotlin", label: "Kotlin Native", defaultPrice: 5499 },
      { id: "swift", label: "Swift (iOS)", defaultPrice: 6999 },
      { id: "flutter", label: "Flutter", defaultPrice: 5999 },
      { id: "react-native", label: "React Native", defaultPrice: 5999 },
      { id: "aws-gcp", label: "AWS / GCP", defaultPrice: 2999 },
      { id: "docker", label: "Docker & Kubernetes", defaultPrice: 4499 },
      { id: "solidity", label: "Solidity / Web3", defaultPrice: 5999 },
      { id: "tensorflow", label: "TensorFlow / PyTorch", defaultPrice: 6999 },
      { id: "pandas", label: "Data Analysis", defaultPrice: 2499 },
    ]
  },
  {
    group: "✨ Add-Ons (Delivery Deliverables)",
    items: [
      { id: "ppt", label: "PPT Presentation", defaultPrice: 699 },
      { id: "report", label: "Thesis Report", defaultPrice: 1299 },
      { id: "viva", label: "Viva Preparation Kit", defaultPrice: 499 },
      { id: "remote", label: "Remote Setup", defaultPrice: 999 },
      { id: "success", label: "Project Success Pack", defaultPrice: 1999 },
    ]
  },
  {
    group: "⏱️ Deadline (Schedule Charges)",
    items: [
      { id: "urgent", label: "1–3 Days", defaultPrice: 1999 },
      { id: "normal", label: "4–7 Days", defaultPrice: 999 },
      { id: "relaxed", label: "8–14 Days", defaultPrice: 0 },
      { id: "flexible", label: "Flexible Schedule", defaultPrice: 0 },
    ]
  }
];
