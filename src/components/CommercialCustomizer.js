...
const WEB_FEATURES_OPTS = [
  ...
  { id: "rbac", label: "Role-based Access", icon: History, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "Complex Permissions", price: 24999 },
  ...
  { id: "subscriptions", label: "Recurring Billing", icon: RefreshCw, color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", desc: "SaaS Subscriptions", price: 29999 },
  { id: "multi_currency", label: "Multi-Currency", icon: ArrowRightLeft, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "Dynamic local pricing", price: 19999 },
  { id: "cms", label: "Admin CMS", icon: Settings, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "Content Management", price: 34999 },
  ...
  { id: "chat", label: "Support Chatbot", icon: Headphones, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "AI/Live Agent Support", price: 14999 },
  ...
  { id: "pwa", label: "PWA Support", icon: Download, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "Installable Web App", price: 19999 },
  { id: "multi_tenant", label: "Multi-Tenant", icon: Briefcase, color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", desc: "SaaS Architecture", price: 59999 },
  { id: "webhooks", label: "Webhooks & APIs", icon: Link, color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", desc: "Expose APIs to clients", price: 34999 },
  { id: "api", label: "3rd Party APIs", icon: Network, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "Zapier, Hubspot, etc.", price: 24999 },
  { id: "websockets", label: "WebSockets", icon: RefreshCcw, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "Real-time Live Data", price: 29999 },
  ...
  { id: "inventory", label: "Inventory/WMS", icon: Box, color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", desc: "Warehouse Management", price: 49999 },
  { id: "affiliate", label: "Referral System", icon: Users, color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", desc: "Affiliate tracking", price: 29999 },
  { id: "gdpr", label: "GDPR Compliance", icon: ShieldCheck, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "Cookie consent, export", price: 14999 },
  { id: "backups", label: "Auto Backups", icon: Database, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "Automated DB snapshots", price: 9999 },
  { id: "blog", label: "Blog / News", icon: FileText, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "Content Marketing Hub", price: 24999 },
];
