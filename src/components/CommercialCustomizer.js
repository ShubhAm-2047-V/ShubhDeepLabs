...
import {
  ...
  Shield, ManageHistory, Autorenew, CurrencyExchange,
  AdminPanelSettings, Search, Brain, SupportAgent, 
  InstallMobile, Business, Webhook, Api, SyncAlt,
  Mail, Inventory, PeopleOutline, Policy, Backup, Article,
...
const PROJECT_OPTS = [
  { id: "app", label: "Mobile App", icon: Smartphone, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "Native or Cross-platform", price: 49999 },
  { id: "website", label: "Website / Web App", icon: Globe, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "SaaS, E-commerce, Portals", price: 29999 },
];

const APP_PLATFORM_OPTS = [
  { id: "android", label: "Android Only", icon: Code, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "Play Store", price: 19999 },
  { id: "ios", label: "iOS Only", icon: Smartphone, color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", desc: "App Store", price: 24999 },
  { id: "both", label: "Cross-Platform", icon: Layers, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "Flutter / React Native", price: 39999 },
];

const WEB_PLATFORM_OPTS = [
  { id: "ecommerce", label: "E-Commerce", icon: ShoppingCart, color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", desc: "Online Store", price: 39999 },
  { id: "saas", label: "SaaS Platform", icon: Cloud, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "Software as a Service", price: 79999 },
  { id: "dashboard", label: "Admin Dashboard", icon: LayoutDashboard, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "Internal Tools", price: 44999 },
  { id: "landing", label: "Landing Page", icon: Globe, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "Marketing Site", price: 14999 },
];

const APP_FEATURES_OPTS = [
  { id: "auth", label: "User Auth", icon: Lock, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "Email/Password Login", price: 4999 },
  { id: "social_auth", label: "Social Login", icon: Users, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "Google, Apple, Facebook", price: 9999 },
  { id: "otp_verify", label: "OTP Verification", icon: Key, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "SMS / WhatsApp OTP", price: 7999 },
  { id: "biometrics", label: "Biometric Login", icon: Fingerprint, color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", desc: "FaceID / TouchID", price: 12999 },
  { id: "payment", label: "Payments", icon: CreditCard, color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", desc: "Stripe/Razorpay", price: 14999 },
  { id: "iap", label: "In-App Purchases", icon: ShoppingBag, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "Subscriptions & IAP", price: 24999 },
  { id: "push", label: "Push Notifications", icon: Bell, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "FCM/APNs Alerts", price: 9999 },
  { id: "chat", label: "Live Chat", icon: MessageCircle, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "Real-time messaging", price: 29999 },
  { id: "video_call", label: "Video/Voice Call", icon: Video, color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", desc: "WebRTC / Agora", price: 39999 },
  { id: "maps", label: "Maps & Routing", icon: Map, color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", desc: "GPS & Live Tracking", price: 24999 },
  { id: "qr_scanner", label: "QR/Barcode", icon: QrCode, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "Built-in scanner", price: 9999 },
  { id: "bluetooth", label: "Bluetooth/IoT", icon: Bluetooth, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "BLE & Hardware APIs", price: 34999 },
  { id: "health", label: "Health SDKs", icon: Heart, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "HealthKit/Google Fit", price: 34999 },
  { id: "file_upload", label: "Media Uploads", icon: UploadCloud, color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", desc: "AWS S3/Cloudinary", price: 12999 },
  { id: "pdf_gen", label: "PDF Reports", icon: FileText, color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", desc: "Generate & Export Docs", price: 14999 },
  { id: "gamification", label: "Gamification", icon: Gamepad2, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "Badges, Streaks & Points", price: 24999 },
  { id: "offline", label: "Offline Mode", icon: WifiOff, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "Local DB Sync (SQLite)", price: 29999 },
  { id: "dark_mode", label: "Dark Mode", icon: Moon, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "Dynamic Theme Support", price: 9999 },
  { id: "multi_lang", label: "Multi-Language", icon: Languages, color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", desc: "i18n Localization", price: 19999 },
  { id: "deep_link", label: "Deep Linking", icon: Link, color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", desc: "Universal Links", price: 9999 },
  { id: "analytics", label: "Analytics SDK", icon: BarChart, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "Firebase / Mixpanel", price: 7999 },
  { id: "crm", label: "CRM Integration", icon: BookOpen, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "Salesforce/HubSpot", price: 34999 },
  { id: "camera", label: "Advanced Camera", icon: Camera, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "Custom UI/AR Elements", price: 49999 },
];

const WEB_FEATURES_OPTS = [
  { id: "auth", label: "User Auth", icon: Lock, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "Email/Password Login", price: 4999 },
  { id: "sso", label: "Enterprise SSO", icon: Shield, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "SAML / OAuth", price: 29999 },
  { id: "rbac", label: "Role-based Access", icon: ManageHistory, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "Complex Permissions", price: 24999 },
  { id: "payment", label: "Payment Gateway", icon: CreditCard, color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", desc: "Stripe/Razorpay", price: 14999 },
  { id: "subscriptions", label: "Recurring Billing", icon: Autorenew, color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", desc: "SaaS Subscriptions", price: 29999 },
  { id: "multi_currency", label: "Multi-Currency", icon: CurrencyExchange, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "Dynamic local pricing", price: 19999 },
  { id: "cms", label: "Admin CMS", icon: AdminPanelSettings, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "Content Management", price: 34999 },
  { id: "seo", label: "Advanced SEO", icon: Search, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "Meta, Schema, Sitemap", price: 19999 },
  { id: "ai", label: "AI Integration", icon: Brain, color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", desc: "OpenAI APIs", price: 39999 },
  { id: "advanced_search", label: "Algolia Search", icon: Search, color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", desc: "Lightning fast indexing", price: 24999 },
  { id: "chat", label: "Support Chatbot", icon: SupportAgent, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "AI/Live Agent Support", price: 14999 },
  { id: "analytics", label: "Analytics Dash", icon: BarChart, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "Custom Dashboards", price: 44999 },
  { id: "pwa", label: "PWA Support", icon: InstallMobile, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "Installable Web App", price: 19999 },
  { id: "multi_tenant", label: "Multi-Tenant", icon: Business, color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", desc: "SaaS Architecture", price: 59999 },
  { id: "webhooks", label: "Webhooks & APIs", icon: Webhook, color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", desc: "Expose APIs to clients", price: 34999 },
  { id: "api", label: "3rd Party APIs", icon: Api, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "Zapier, Hubspot, etc.", price: 24999 },
  { id: "websockets", label: "WebSockets", icon: SyncAlt, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "Real-time Live Data", price: 29999 },
  { id: "email", label: "Email Marketing", icon: Mail, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "Mailchimp / Sendgrid", price: 11999 },
  { id: "inventory", label: "Inventory/WMS", icon: Inventory, color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", desc: "Warehouse Management", price: 49999 },
  { id: "affiliate", label: "Referral System", icon: PeopleOutline, color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", desc: "Affiliate tracking", price: 29999 },
  { id: "gdpr", label: "GDPR Compliance", icon: Policy, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "Cookie consent, export", price: 14999 },
  { id: "backups", label: "Auto Backups", icon: Backup, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "Automated DB snapshots", price: 9999 },
  { id: "blog", label: "Blog / News", icon: Article, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "Content Marketing Hub", price: 24999 },
];

const TIMELINE_OPTS = [
  { id: "urgent", label: "1-2 Weeks", icon: Zap, color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", desc: "MVP Fast Track (Rush Fee)", price: 39999 },
  { id: "standard", label: "3-4 Weeks", icon: Clock, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", desc: "Standard Dev", price: 0 },
  { id: "relaxed", label: "1-2 Months", icon: CalendarDays, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", desc: "Full Scale (Discount)", price: -15000 },
  { id: "flexible", label: "Flexible", icon: InfinityIcon, color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", desc: "No rush", price: 0 },
];
