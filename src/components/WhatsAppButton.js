  ...
  return (
    <div className="flex items-center group font-marker">
      ...
      <motion.a
        ...
        className="w-12 h-12 sm:w-14 sm:h-14 bg-[#A5D6A7] rounded-full flex items-center justify-center text-[#2C2C2C] shadow-[3px_4px_0_#2C2C2C] hover:bg-[#81C784] hover:shadow-[4px_5px_0_#2C2C2C] transition-all duration-200 border-2 border-[#2C2C2C]"
