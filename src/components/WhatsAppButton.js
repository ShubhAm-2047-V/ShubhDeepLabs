...
export default function WhatsAppButton() {
  ...
  const message = encodeURIComponent("Hello, I want to discuss my academic project.");
  const whatsappUrl = `https://wa.me/${phoneNumber}?text=${message}`;

  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center group font-marker">
      ...
      <motion.a
        ...
        className="w-14 h-14 bg-[#A5D6A7] rounded-full flex items-center justify-center text-[#2C2C2C] shadow-[3px_4px_0_#2C2C2C] hover:bg-[#81C784] hover:shadow-[4px_5px_0_#2C2C2C] transition-all duration-200 border-2.5 border-[#2C2C2C]"
