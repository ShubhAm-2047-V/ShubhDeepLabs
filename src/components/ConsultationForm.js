        ...
        <div className="lg:col-span-7">
          <form onSubmit={handleFormSubmit} className="space-y-4 sand-dune-card-soft p-6 border border-[#D5C4A6]">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="consult-name" className="block text-xs font-bold text-[#3B2818] uppercase mb-1">Your Full Name *</label>
                <input
                  id="consult-name"
                  type="text"
                  name="name"
                  ...
                  className="w-full text-sm px-4 py-3 bg-white/90 border border-[#D5C4A6] rounded-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2E3B2B] text-[#3B2818] font-medium"
              ...
              <div>
                <label htmlFor="consult-company" className="block text-xs font-bold text-[#3B2818] uppercase mb-1">Company / Organization</label>
                <input
                  id="consult-company"
                  type="text"
                  name="company"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="consult-phone" className="block text-xs font-bold text-[#3B2818] uppercase mb-1">Phone Number *</label>
                <input
                  id="consult-phone"
                  type="tel"
                  name="phone"
              ...
              <div>
                <label htmlFor="consult-email" className="block text-xs font-bold text-[#3B2818] uppercase mb-1">Work Email *</label>
                <input
                  id="consult-email"
                  type="email"
                  name="email"
            ...
            <div>
              <label htmlFor="consult-message" className="block text-xs font-bold text-[#3B2818] uppercase mb-1">Project Scope & Requirements *</label>
              <textarea
                id="consult-message"
                name="message"
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-sage-green w-full py-4 text-base flex items-center justify-center cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2E3B2B]"
              aria-label="Submit Business Consultation Request Form"
            >
