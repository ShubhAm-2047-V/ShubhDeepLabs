...
export const STEPS = [
  {
    ...
    type: "single",
    options: [
      { id: "diploma",     label: "Diploma",                  icon: Laptop,     color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", price: 0 },
      { id: "engineering", label: "Engineering (B.E./B.Tech)", icon: Code,       color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", price: 3999 },
      { id: "mtech",       label: "M.Tech / Research",        icon: Cpu,        color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", price: 7499 },
      { id: "bca-mca",     label: "BCA / MCA",                icon: Database,   color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", price: 2999 },
      { id: "bsc-msc",     label: "B.Sc / M.Sc (IT)",         icon: Database,   color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", price: 2499 },
      { id: "ai-ml",       label: "AI / ML",                  icon: Brain,      color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", price: 5999 },
      { id: "android",     label: "Android App",              icon: Smartphone, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", price: 4999 },
      { id: "phd",         label: "PhD / Thesis",             icon: BookOpen,   color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", price: 9999 },
      { id: "web-dev",     label: "Web Development",          icon: Globe,      color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", price: 3999 },
      { id: "ui-ux",       label: "UI/UX Design",             icon: LayoutDashboard, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", price: 1999 },
      { id: "cyber-sec",   label: "Cyber Security",           icon: ShieldCheck, color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", price: 6499 },
      { id: "blockchain",  label: "Blockchain / Web3",        icon: Link,       color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", price: 6999 },
    ],
  },
  {
    id: "tech",
    ...
    options: [
      ...
      { id: "vue",            label: "Vue.js",                   icon: LayoutDashboard,color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", price: 2499, desc: "Lightweight web apps",
        tooltip: "A progressive framework for building user interfaces. 🟢" },
      { id: "angular",        label: "Angular",                  icon: Globe,          color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", price: 2999, desc: "Enterprise frontends",
        tooltip: "A robust framework by Google. 🔴" },
      { id: "svelte",         label: "Svelte",                   icon: Zap,            color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", price: 2499, desc: "Fast web apps",
        tooltip: "Compiles your code to tiny, framework-less vanilla JS. ⚡" },
      { id: "python-flask",   label: "Python + Flask",           icon: Code,           color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", price: 1999,  desc: "REST APIs & ML backends",
        tooltip: "Flask turns Python scripts into a web server. 🐍" },
      { id: "nodejs",         label: "Node.js",                  icon: Server,         color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", price: 2499, desc: "Fast JS backend",
        tooltip: "Run JavaScript on the server. 🟢" },
      { id: "django",         label: "Django",                   icon: Code,           color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", price: 2999, desc: "Robust Python backend",
        tooltip: "The web framework for perfectionists with deadlines. 🐍" },
      { id: "springboot",     label: "Spring Boot (Java)",       icon: Code,           color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", price: 4499, desc: "Enterprise Java",
        tooltip: "The enterprise standard for large backend systems. ☕" },
      { id: "laravel",        label: "PHP / Laravel",            icon: Code,           color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", price: 2499, desc: "Elegant PHP framework",
        tooltip: "The PHP framework for web artisans. 🐘" },

      { id: "sql",            label: "PostgreSQL/MySQL",         icon: Database,       color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", price: 1499, desc: "Relational DBs",
        tooltip: "Relational databases for structured data." },
      { id: "mongodb",        label: "MongoDB",                  icon: Database,       color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", price: 1499, desc: "NoSQL document DB",
        tooltip: "Flexible JSON-like document database." },
      { id: "redis",          label: "Redis",                    icon: Zap,            color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", price: 999, desc: "High-speed caching",
        tooltip: "In-memory data structure store." },
      { id: "firebase",       label: "Firebase",                 icon: Flame,          color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", price: 1499,  desc: "Auth, real-time DB",
        tooltip: "Google's magic toolkit. 🔥" },

      { id: "android-dev",    label: "Android (Java/XML)",       icon: Smartphone,     color: "bg-[#E8F5E9]", border: "border-[#26A69A]", accent: "#26A69A", price: 5499, desc: "Legacy Android apps",
        tooltip: "Build native apps for Android. 📱" },
      { id: "kotlin",         label: "Kotlin Native",            icon: Smartphone,     color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", price: 5499, desc: "Modern Android apps",
        tooltip: "Modern Android development." },
      { id: "swift",          label: "Swift (iOS)",              icon: Smartphone,     color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", price: 6999, desc: "Native Apple apps",
        tooltip: "Build native apps for iOS." },
      { id: "flutter",        label: "Flutter",                  icon: Smartphone,     color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", price: 5999, desc: "Cross-platform mobile",
        tooltip: "Build for iOS and Android from one codebase." },
      { id: "react-native",   label: "React Native",             icon: Code,           color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", price: 5999, desc: "JS cross-platform",
        tooltip: "Build for iOS and Android using React." },

      { id: "aws-gcp",        label: "AWS / GCP",                icon: Cloud,          color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", price: 2999, desc: "Cloud infrastructure",
        tooltip: "Deploy on Amazon Web Services or Google Cloud." },
      { id: "docker",         label: "Docker & Kubernetes",      icon: Server,         color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", price: 4499, desc: "Container deployment",
        tooltip: "Containerize and orchestrate your applications." },
      { id: "solidity",       label: "Solidity / Web3",          icon: Link,           color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", price: 5999, desc: "Smart Contracts",
        tooltip: "Build decentralized applications and smart contracts." },
      
      { id: "tensorflow",     label: "TensorFlow / PyTorch",     icon: Brain,          color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", price: 6999, desc: "Deep learning",
        tooltip: "Train and deploy deep learning models." },
      { id: "pandas",         label: "Data Analysis",            icon: BarChart,       color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", price: 2499, desc: "Data & visualization",
        tooltip: "Data processing, cleaning, and visualization." },
    ],
  },
  {
    id: "addons",
    ...
    type: "multi",
    options: [
      { id: "ppt",        label: "PPT Presentation",     icon: Presentation, color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", price: 699  },
      { id: "report",     label: "Thesis Report",        icon: FileText,     color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", price: 1299 },
      { id: "viva",       label: "Viva Preparation Kit", icon: BookOpen,     color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", price: 499  },
      { id: "remote",     label: "Remote Setup",         icon: ShieldCheck,  color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", price: 999  },
      { id: "success",    label: "Project Success Pack", icon: Zap,          color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", price: 1999, desc: "PPT + Thesis + Viva + Remote Setup" },
    ],
  },
  {
    id: "timeline",
    ...
    type: "single",
    options: [
      { id: "urgent",   label: "1–3 Days",             icon: Zap,          color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", price: 1999 },
      { id: "normal",   label: "4–7 Days",             icon: Clock,        color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", price: 999  },
      { id: "relaxed",  label: "8–14 Days",            icon: CheckCircle2, color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", price: 0    },
      { id: "flexible", label: "Flexible Schedule",    icon: Sparkles,     color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", price: 0    },
    ],
  },
];
