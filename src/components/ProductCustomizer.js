  ...
  },
  {
    ...
    options: [
      ...
      { id: "vue",            label: "Vue.js",                   icon: LayoutDashboard,color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", price: 2499, desc: "Lightweight web apps",
        tooltip: "A progressive framework for building user interfaces. Very approachable and versatile. 🟢" },
      { id: "angular",        label: "Angular",                  icon: Globe,          color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", price: 2999, desc: "Enterprise frontends",
        tooltip: "A robust framework by Google for building large-scale enterprise applications. 🔴" },
      { id: "svelte",         label: "Svelte",                   icon: Zap,            color: "bg-[#FFF9C4]", border: "border-[#FFCA28]", accent: "#FFCA28", price: 2499, desc: "Fast web apps",
        tooltip: "Compiles your code to tiny, framework-less vanilla JS. Extremely fast performance. ⚡" },
      ...
      { id: "nodejs",         label: "Node.js",                  icon: Server,         color: "bg-[#E1F5FE]", border: "border-[#42A5F5]", accent: "#42A5F5", price: 2499, desc: "Fast JS backend",
        tooltip: "Run JavaScript on the server. Non-blocking and extremely scalable. 🟢" },
      { id: "django",         label: "Django",                   icon: Code,           color: "bg-[#F3E5F5]", border: "border-[#AB47BC]", accent: "#AB47BC", price: 2999, desc: "Robust Python backend",
        tooltip: "The web framework for perfectionists with deadlines. Built-in admin panel and ORM. 🐍" },
      { id: "springboot",     label: "Spring Boot (Java)",       icon: Code,           color: "bg-[#E8F5E9]", border: "border-[#66BB6A]", accent: "#66BB6A", price: 3499, desc: "Enterprise Java",
        tooltip: "The enterprise standard for large, secure, and scalable backend systems. ☕" },
      { id: "laravel",        label: "PHP / Laravel",            icon: Code,           color: "bg-[#FFEBEE]", border: "border-[#EF5350]", accent: "#EF5350", price: 1999, desc: "Elegant PHP framework",
        tooltip: "The PHP framework for web artisans. Excellent for rapid full-stack development. 🐘" },
